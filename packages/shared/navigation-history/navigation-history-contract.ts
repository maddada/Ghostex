 ...
 * gxserver owns that trail (see `gxserver-rs/src/navigation_history`); this file
...
export function navigationHistoryTooltip(
...
export function normalizeNavigationHistoryEntry(
  value: unknown,
