...
const OPEN_AND_CLOSED = [
  ...
  "",
  "```",
  "FAIL sidebar/chat/session-chat-details.test.ts",
...
const EVERYTHING_INSIDE = [
  ...
  "",
  "```ts title=sidebar/chat/session-chat-details.ts",
  ...
  "| --- | --- | --- |",
  "| gpui | `gpui/sidebar/chat-main.tsx` | one inlined `file://` script |",
  "| web | `ghostex-web/src/app/chat-page.tsx` | a normal Vite chunk |",
  "| mobile | `mobile-chat/chat-main.tsx` | one self-contained `index.html` |",
  "",
  "And an inline path is still a chip: `sidebar/styles/chat.css:1381`.",
  "",
  "</details>",
  "",
  ...
  "- `zehn-rs/` is the engine",
  "- `gxserver-rs/src/agent_prompt_search.rs` is the API",
  "- `sidebar/find/` is the shared UI",
  "</details>",
  "",
...
const HOSTILE_HTML = [
  ...
  '<img src="x" onerror="window.__ghostexChatXssCanary()">',
  "",
  "The markdown around them still works: `shared/session-chat.ts:12`.",
  "",
  "</details>",
].join("\n");
