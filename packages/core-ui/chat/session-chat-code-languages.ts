...
export type SessionChatCodeLanguage = (typeof SESSION_CHAT_CODE_LANGUAGES)[number];
 ...
 */
export function resolveSessionChatCodeLanguage(info: string | null | undefined): SessionChatCodeLanguage | null {
  ...
  return LANGUAGE_KEYS.has(normalized) ? (normalized as SessionChatCodeLanguage) : null;
}
