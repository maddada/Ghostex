...
function Pane({ children, label, width }: { children: ReactNode; label: string; width?: number }) {
  return (
    <div
...
function SessionChatFileChipsStory({ theme }: { theme: 'dark' | 'light' }) {
  return (
    <div className='flex h-screen min-h-[46rem] gap-2 bg-[#0a0a0a] p-2'>
      <Pane label='after — 385px, the real transcript width' width={TRANSCRIPT_COLUMN_WIDTH}>
