...
export const ADD_PROJECT_SOURCES: readonly AddProjectSourceId[] = ['url', ...ADD_PROJECT_PROVIDER_SOURCES];
 ...
 */
export function addProjectNewFolderMessage(input: { readonly name: string; readonly parentPath: string }): string {
...
export function matchesAddProjectFilter(query: string, title: string, searchTerms: readonly string[] = []): boolean {
