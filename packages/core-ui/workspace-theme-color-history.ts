...
/*
CDXC:StateSync 2026-06-02-13:58:
Shared helpers must stay side-effect free after the gxserver/native ownership split. Recent workspace theme colors are macOS/sidebar UI-local persistence, so localStorage access belongs in the sidebar layer while packages/shared/workspace-project-appearance keeps only pure color normalization.
*/
