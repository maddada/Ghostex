...
import {
  EditTicketDialog,
  NewTicketDialog,
} from "@/apps/desktop/views/project-board/ticket-dialogs";
...
import type {
  DetailDraft,
  TicketFormDraft,
} from "@/apps/desktop/views/project-board/types";
import type {
  BoardColumn,
  BoardTicket,
...
function NewTicketStory() {
  ...
  const [startLocation, setStartLocation] = useState<"currentProject" | "newWorktree">(
    "currentProject",
  );
  return (
    <DialogCanvas>
    ...
    <DialogCanvas>
      <AutomationDialog
        ...
        automationSessionSelectItems={[
          { label: "Kanban dialog redesign", value: "ghostex-104" },
        ]}
