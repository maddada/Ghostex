...
while (argv.length > 0) {
  ...
  switch (argument) {
    case '--disable-macos':
      ...
      break;
    case '--disable-linux':
      enabled.linux_deb = enabled.linux_rpm = enabled.linux_tar = false;
      break;
    case '--disable-linux-deb':
      enabled.linux_deb = false;
      break;
    case '--disable-linux-rpm':
      enabled.linux_rpm = false;
      break;
    case '--disable-linux-tar':
      enabled.linux_tar = false;
      break;
    case '--disable-windows-x64':
      enabled.windows_x64 = false;
      break;
    case '--disable-windows-arm64':
      enabled.windows_arm64 = false;
      break;
    case '--disable-android':
      enabled.android = false;
      break;
    case '--disable-gxserver-linux-x64':
      enabled.gxserver_linux_x64 = false;
      break;
    case '--disable-gxserver-linux-arm64':
      enabled.gxserver_linux_arm64 = false;
      break;
    case '--disable-gxserver-wsl-windows-x64':
      enabled.gxserver_wsl_windows_x64 = false;
      break;
    case '--disable-gxserver-wsl-windows-arm64':
      enabled.gxserver_wsl_windows_arm64 = false;
      break;
    case '--skip-sparkle':
      updateSparkle = false;
      break;
    case '--skip-windows-signing':
      signWindows = false;
      break;
    case '--prerelease':
      prerelease = true;
...
const args = [
  ...
  '-f',
  `update_sparkle=${updateSparkle}`,
  '-f',
  `sign_windows=${signWindows}`,
  '-f',
