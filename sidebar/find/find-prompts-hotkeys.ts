...
export function resolveFindPromptsAction(
  event: FindPromptsKeyEvent,
  mode: FindPromptsMode,
): FindPromptsAction | null {
  if (mode === "forkPicker") {
