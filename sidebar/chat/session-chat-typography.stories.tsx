 ...
 */
const CLAUDE_ICON = new URL("../../src/assets/claude.svg?no-inline", import.meta.url).href;
const CODEX_ICON = new URL("../../src/assets/codex.svg?no-inline", import.meta.url).href;
const GEMINI_ICON = new URL("../../src/assets/gemini.svg?no-inline", import.meta.url).href;
