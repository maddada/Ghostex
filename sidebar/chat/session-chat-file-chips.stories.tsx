...
const PATH_SHAPES = [
  ...
  "",
  "- Bare repo-relative path: `gpui/src/main.rs`",
  "- With a line: `sidebar/styles/chat.css:913`",
  "- With a line and a column: `gpui/src/cef/shell.rs:42:8`",
  "- Deeply nested: `gxserver-rs/src/ghostex_cli/actions.rs:117`",
  ...
  "- A dotfile in a folder: `gpui/.cargo/config.toml`",
  ...
  "`sidebar/chat/session-chat-view.tsx`, the markdown renderer under it is",
  "`sidebar/chat/session-chat-markdown.tsx:463`, and the styles both of them",
  "read come from `sidebar/styles/chat.css`.",
].join("\n");
...
const SAME_BASENAMES = [
  ...
  "",
  "1. `sidebar/styles/chat.css:913` is the shared sidebar stylesheet.",
  "2. `ghostex-web/src/styles/chat.css` is the web app's own copy.",
  "",
  "Same for the two mains and the two mounts:",
  "",
  "- `gpui/src/main.rs` vs `gxserver-rs/src/main.rs`",
  "- `gpui/sidebar/chat-main.tsx:586` vs `mobile-chat/chat-main.tsx:141`",
].join("\n");
...
const LONG_PATHS = [
  ...
  "",
  "- `gxserver-rs/src/ghostex_cli/session_chat_terminal_activity.rs:1284:37`",
  "- `/Users/madda/dev/_active/Ghostex/sidebar/chat/session-chat-terminal-notice-card.tsx:212`",
  "- `node_modules/@tabler/icons-react/dist/esm/tabler-icons-react.mjs`",
  "- `ghostex-web/src/connections/gxserver-client-presentation-cache.ts:77:14`",
  "",
  "And here they are in running prose, several to a paragraph: the notice card",
  "in `sidebar/chat/session-chat-terminal-notice-card.tsx:212` reads its screen",
  "classifier from `gxserver-rs/src/session_chat_terminal_activity.rs:1284:37`,",
  "which the CLI also calls from `gxserver-rs/src/ghostex_cli/sessions.rs:940`,",
  "and all three agree with `shared/gxserver-presentation-sidebar-projection.ts`.",
...
const TABLE_WITH_PATHS = [
  ...
  "| --- | --- | --- |",
  "| gpui | `gpui/sidebar/chat-main.tsx:586` | `sidebar/styles/chat.css:913` |",
  "| web | `ghostex-web/src/connections/gxserver-client-presentation-cache.ts:77:14` | `ghostex-web/src/styles/chat.css` |",
  "| mobile | `mobile-chat/session-chat-main.tsx:141` | `sidebar/styles/chat.css` |",
  "",
...
const NOT_PATHS = [
  ...
  "`--flag`, `-g '!ghostty/**'`, or `--skip-android`. Kill it with `^g`, and",
  ...
  "",
  "```ts",
  'import { SessionChatMarkdown } from "./sidebar/chat/session-chat-markdown";',
  '// see sidebar/styles/chat.css:913 for the chip styles',
  "```",
  "",
  "And a path inside a real markdown link keeps the link's own behaviour:",
  "[session-chat-links.tsx](sidebar/chat/session-chat-links.tsx).",
].join("\n");
