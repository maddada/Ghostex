...
fn insert_optional_returned_prompt(
    ...
    returned_prompt::insert_session_chat_returned_prompt(
        frame,
        &config.project_id,
        &config.session_id,
    );
    ...
    loop {
        ...
        match outcome {
            ...
            FollowerDrainOutcome::Snapshot {
                ...
                returned_prompt::filter_session_chat_returned_prompts(
                    &config.project_id,
                    &config.session_id,
                    &mut tail.messages,
                    &mut tail.lifecycle,
            ...
            FollowerDrainOutcome::Idle => {
                ...
                if let Some((retracted, lifecycle)) =
                    returned_prompt::take_session_chat_returned_prompt_retraction(
                        &config.project_id,
                        &config.session_id,
                    )
                {
