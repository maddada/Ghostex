...
struct SessionChatQueuePresentationCounts {
    total: u64,
    failed: u64,
}

fn read_session_chat_queue_counts(
    db: &Connection,
...
fn insert_session_chat_queue_presentation_payload(snapshot: &mut Value, db: &Connection) {
...
fn insert_session_chat_queue_session_projection(
    session: &mut Value,
    db: &Connection,
    project_id: &str,
    session_id: &str,
