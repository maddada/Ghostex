 ...
 * packages/core-ui/sidebar-command-icon.tsx. `filled:` marks the ids the desktop draws
...
// glyphs packages/core-ui/session-tag-ui.tsx and packages/core-ui/sidebar-command-icon.tsx draw
