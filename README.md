...
Latest download: [macOS Apple Silicon DMG](https://github.com/maddada/Ghostex/releases/latest/download/ghostex-7.3.0-arm64.dmg).
...
Latest downloads: [Windows x64](https://github.com/maddada/Ghostex/releases/latest/download/ghostex-7.3.0-windows-x64.exe) · [Windows ARM64](https://github.com/maddada/Ghostex/releases/latest/download/ghostex-7.3.0-windows-arm64.exe). Ghostex manages its terminals, gxserver, Source editor, and T3 Code runtime inside the selected WSL2 distribution.
...
Latest downloads: [Linux DEB](https://github.com/maddada/Ghostex/releases/latest/download/ghostex_7.3.0_amd64.deb) · [Linux RPM](https://github.com/maddada/Ghostex/releases/latest/download/ghostex-7.3.0-1.x86_64.rpm).
