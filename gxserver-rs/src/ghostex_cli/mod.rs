...
fn is_known_command(name: &str) -> bool {
    const NAMES: [&str; 101] = [
        ...
        "install-agent-orchestration-skill", "fable-5.6-orchestration",
        "install-fable-5.6-orchestration-skill", "generate-title",
...
fn run_command(name: &str, args: &[String]) -> CliResult<()> {
    ...
    match name {
        ...
        "install-fable-5.6-orchestration-skill" => skills::install_fable56_orchestration_skill_command(args),
