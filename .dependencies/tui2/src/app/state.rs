...
pub struct AppState {
    ...
    pub request_ghostex_attach_session_key: Option<String>,
    pub request_ghostex_create_terminal: bool,
    pub request_ghostex_create_terminal_target: Option<(Option<String>, Option<String>)>,
    ...
    pub ghostex_mode: bool,
    pub ghostex_sessions: Vec<crate::ghostex::SessionItem>,
    pub ghostex_active_session_key: Option<String>,
    pub ghostex_session_workspaces: std::collections::HashMap<String, String>,
    pub ghostex_status: Option<String>,
