...
pub fn terminalOptions(
    ...
    return .{
        ...
        // Note (Ghostex 2026-08-14): this stays on upstream semantics (Debug
        // => true) because Zig tests share these modules and comptime-assert
        // that the slow checks are enabled. To get a fast development
        // GhosttyKit without the page-integrity scans, build the xcframework
        // with -Doptimize=ReleaseSafe instead of Debug.
