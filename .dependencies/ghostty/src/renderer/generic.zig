...
pub fn Renderer(comptime GraphicsAPI: type) type {
    return struct {
        ...
        pub fn frameCompleted(
            ...
            // ghostty_surface_free. The swap chain is guaranteed to exist
            // here because teardown waits for this completion.
        ...
        fn rebuildRow(
            ...
            for (
                ...
                if (preedit_range) |range| preedit: {
                    ...
                    // Ghostex patch (2026-07-11): bound the scan — the last
                    // shaped run can end before x, and walking past the end
                    // of shaper_cells is UB/panic in safe builds.
