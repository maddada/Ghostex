...
The sidebar's behaviour is Rust (`packages/gx-core/` for the rules, `apps/desktop/src/app/gx_store/` for the store and its gxserver calls, `apps/desktop/src/app/native_sidebar/` for the renderer); no part of it runs in QuickJS any more. Chat follows the same shape. Port plan and status: `docs/2026-09-21/rust-chat/PLAN.md`.
