...
import { ManageAnnotation, ManageAnnotationPreview, ManageCapturedSelection, ManageMeoAnnotationDecoration, ManageMeoMode, ManageMeoSelectionState, ManageResolvedAnnotationRange, ManageSelectionAnchor } from "./types";
import { ManageTooltipButton } from "./manage-tooltip-button";
import { defaultManageSelectionAnchor, manageAnnotationColor, meoSelectionToolbarPosition, normalizeAnnotationQuote } from "./annotation-store";
...
export function buildManageMeoAnnotationDecorations(decorations: readonly ManageMeoAnnotationDecoration[]): DecorationSet {
