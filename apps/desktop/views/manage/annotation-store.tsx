...
import { MANAGE_ANNOTATION_IMAGE_MAX_BYTES, MANAGE_ANNOTATION_MAX_IMAGES, MANAGE_ANNOTATION_SCHEMA_VERSION, MANAGE_COMMENT_ANNOTATION_COLOR, MANAGE_QUICK_LABELS, MANAGE_REDLINE_ANNOTATION_COLOR, MANAGE_SELECTION_MAX_LENGTH, MANAGE_SELECTION_TOOLBAR_EDGE_MARGIN, MANAGE_SELECTION_TOOLBAR_WIDTH_ESTIMATE } from "./constants";
import { ManageAnnotation, ManageAnnotationImage, ManageAnnotationStore, ManageMeoSelectionState, ManageQuickLabelId, ManageSelectionAnchor, isRecord } from "./types";
