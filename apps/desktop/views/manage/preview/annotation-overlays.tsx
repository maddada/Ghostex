...
import { MANAGE_COMMENT_ANNOTATION_COLOR, MANAGE_DISMISS_TOOLBAR_COLOR, MANAGE_MEO_HEADING_COLOR, MANAGE_QUICK_LABELS } from "../constants";
import { ManageAnnotation, ManageAnnotationPreview, ManageCommentDraft, ManageQuickLabel, ManageSelectionAnchor } from "../types";
import { ManageTooltipButton } from "../manage-tooltip-button";
import { annotationDisplayNote, annotationPreviewCardStyle, annotationPreviewText, annotationTypeLabel, clampManageSelectionToolbarLeft, commentPopoverStyle, manageAnnotationColor, manageToolbarActionStyle, renderManageQuickLabelIcon } from "../annotation-store";
