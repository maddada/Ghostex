...
export function BatteryGlyph({ size = 17 }: { size?: number }) {
  return (
    <Glyph size={size}>
      <rect fill='none' height='9' rx='2.4' stroke='currentColor' strokeWidth='1.4' width='16' x='2' y='7.5' />
      <rect fill='currentColor' height='5.4' rx='1.2' width='11' x='3.5' y='9.3' />
      <path d='M20 10.5v3a1.9 1.9 0 0 0 0-3z' fill='currentColor' opacity='0.7' />
    </Glyph>
  );
}
...
export function ControlCenterGlyph({ size = 15 }: { size?: number }) {
  return (
    <Glyph size={size}>
      <rect fill='none' height='7' rx='3.5' stroke='currentColor' strokeWidth='1.5' width='18' x='3' y='3' />
      <circle cx='8' cy='6.5' fill='currentColor' r='1.6' />
      <rect fill='none' height='7' rx='3.5' stroke='currentColor' strokeWidth='1.5' width='18' x='3' y='14' />
...
export function SearchGlyph({ size = 14 }: { size?: number }) {
  return (
    <Glyph size={size}>
      ...
      <path d='m16 16 4.5 4.5' fill='none' stroke='currentColor' strokeLinecap='round' strokeWidth='1.7' />
    </Glyph>
  );
}
...
export function WarningGlyph({ size = 14 }: { size?: number }) {
  return (
    <Glyph size={size}>
      <path d='M12 4.5 21 19.5H3z' fill='none' stroke='currentColor' strokeLinejoin='round' strokeWidth='1.6' />
...
export function StarGlyph({ size = 13 }: { size?: number }) {
  return (
    <Glyph size={size}>
      <path d='m12 4 2.5 5.2 5.5.8-4 3.9 1 5.6-5-2.7-5 2.7 1-5.6-4-3.9 5.5-.8z' fill='currentColor' />
    </Glyph>
  );
}
  ...
  return (
    <Glyph size={size}>
      <path
        ...
        strokeWidth='1.6'
      />
      <path d='M12 7.5V12l3 1.8' fill='none' stroke='currentColor' strokeLinecap='round' strokeWidth='1.6' />
    </Glyph>
  );
}
...
export function FinderGlyph({ size = 26 }: { size?: number }) {
  return (
    <Glyph size={size}>
      <path d='M8 8.5v2M16 8.5v2' fill='none' stroke='currentColor' strokeLinecap='round' strokeWidth='1.8' />
      <path
...
export function MailGlyph({ size = 26 }: { size?: number }) {
  return (
    <Glyph size={size}>
      <rect fill='none' height='12' rx='2.4' stroke='currentColor' strokeWidth='1.6' width='17' x='3.5' y='6' />
      <path
...
export function MusicGlyph({ size = 26 }: { size?: number }) {
  return (
    <Glyph size={size}>
      <path d='M10 17V7.2l7-1.7v9.6' fill='none' stroke='currentColor' strokeLinejoin='round' strokeWidth='1.7' />
