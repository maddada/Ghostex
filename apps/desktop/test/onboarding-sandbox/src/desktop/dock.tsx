...
import ghostexIconUrl from '@/apps/desktop/resources/AppIcon.appiconset/icon_256x256.png';
import { useSandboxStore } from '../state/store';
import { CompassGlyph, FinderGlyph, MailGlyph, MusicGlyph, NotesGlyph, TerminalGlyph, TrashGlyph } from './icons';
import './dock.css';
