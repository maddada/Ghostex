...
export const CODE_REFS = {
  ...
  cefReady:
    'apps/desktop/src/app/terminal_sync/cef_and_command_terminal_focus.rs:222 initialize_cef → sidebar surface ready',
  ...
  portlessCheck:
    'apps/desktop/src/app/os_integration/notifications_and_portless.rs:368 start_gpui_portless_setup_prompt_check',
  progressiveHooks:
...
export const OS_INTEGRATION_TOAST = {
  ...
  message: 'Open Settings > OS Integration to set Ghostex as your editor or terminal target.',
} as const;
...
export const GXSERVER_BRANCH_TOASTS: Record<GxserverHealthScenario, GxserverBranchToast | null> = {
  ...
  healthyToolsUnavailable: {
    ...
    message: 'The running gxserver does not match the tools bundled with this Ghostex build.',
  },
  buildMismatch: {
    kind: 'info',
