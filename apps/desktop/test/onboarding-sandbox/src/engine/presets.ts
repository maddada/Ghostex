 ...
 * the exact strings gpui writes (apps/desktop/src/app/helpers/board_gxserver/focus_state.rs), so a "returning user" state
...
function withAgents(env: SimEnvState, agentIds: readonly SimAgentId[], hookState: SimHookState): SimEnvState {
