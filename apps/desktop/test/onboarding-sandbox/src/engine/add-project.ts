...
export function readAddProjectOperation(
  ...
  return typeof operation === 'string' ? (operation as SidebarAddProjectDialogOperation) : undefined;
}

export async function answerAddProjectRequest(message: ModalHostOutboundMessage): Promise<AddProjectAnswer> {
