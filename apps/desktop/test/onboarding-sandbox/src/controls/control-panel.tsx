  ...
  if (collapsed) {
    return (
      <aside className='cp cp--collapsed'>
        <button className='cp-expand' onClick={() => setCollapsed(false)} title='Show the inspector' type='button'>
  ...
  return (
    <aside className='cp'>
      <header className='cp-header'>
        ...
        <button className='cp-collapse' onClick={() => setCollapsed(true)} title='Collapse the inspector' type='button'>
          ›
        </button>
      </header>
