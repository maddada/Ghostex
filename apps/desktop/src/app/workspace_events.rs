...
impl GhostexGpuiApp {
    ...
    pub(crate) fn receive_sidebar_bridge_event(
        ...
        */
        ...
        match event {
            ...
            // Nothing posts this since the store publishes the focus itself (gx_store/focus_publish.rs);
            // the bridge entry goes with the rest of the runtime's bridge in step 3.
    ...
    pub(crate) fn receive_sidebar_workspace_terminal_focus_payload(
        ...
        */
        ...
        self.gx_store_request_workspace_focus(message, cx);
    }
