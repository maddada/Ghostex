...
export interface GpuiSidebarRuntimeGitMethods {
  ...
  confirmRemoteSidebarGitDirectMerge(
    pending: GpuiPendingGitCommitRequest & { remoteReference: GpuiRemoteProjectReference },
    message: Extract<SidebarToExtensionMessage, { type: 'confirmSidebarGitDirectMerge' }>
  ): Promise<void>;
  ...
  openRemoteSidebarGitChangedFileDiff(
  ...
  runSidebarGitPromptAction(
    project: GxserverProjectDomainState,
    title: string,
    prompt: string,
    agentId?: string
  ): Promise<void>;
  runRemoteSidebarGitPromptAction(
    remoteScope: GpuiRemoteProjectScope,
    title: string,
    prompt: string,
    agentId?: string
  ...
  isGitPreferenceRemoteScope(scopeMessage?: { groupId?: string; projectId?: string }): boolean;
  ...
  runRemoteBeadsAction(
    remoteScope: GpuiRemoteProjectReference,
    params: Record<string, unknown>
  ): Promise<GxserverTypedOperationResult>;
  runRemoteGitMutation(
    remoteScope: GpuiRemoteProjectScope,
    startedTitle: string,
    finishedTitle: string,
    operation: () => Promise<void>
