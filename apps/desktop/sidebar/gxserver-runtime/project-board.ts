...
export interface GpuiSidebarRuntimeProjectBoardMethods {
  ...
  resolveGpuiProjectBoardDomainScope(request: {
    projectId?: string;
    projectPath?: string;
  }): Promise<{
  ...
  selectGpuiProjectBoardDomainProject(request: { projectId?: string; projectPath?: string }, projects: readonly GxserverProjectDomainState[]): GxserverProjectDomainState;
  createGpuiProjectBoardConversationState(request: {
    projectId?: string;
    projectPath?: string;
  }): Promise<ProjectBoardConversationState>;
  readGpuiProjectBoardConversationLinks(linkStoreProjects: readonly GxserverProjectDomainState[]): BeadConversationLink[];
  createGpuiProjectBoardAgentOptions(): ProjectBoardAgentOption[];
  createGpuiProjectBoardSessionOptions(boardProject: GxserverProjectDomainState, linkStoreProjects?: readonly GxserverProjectDomainState[]): ProjectBoardSessionOption[];
  findGpuiProjectBoardLinkedSessionOption(boardProject: GxserverProjectDomainState, ghostexSessionId: string): ProjectBoardSessionOption | undefined;
  checkGpuiProjectBoardLinkAvailability(boardProject: GxserverProjectDomainState, ghostexSessionId: string): Promise<{ restorable: boolean; resumable: boolean; title?: string }>;
  checkGpuiProjectBoardLinkResumable(reference: {
    projectId: string;
    sessionId: string;
  }): Promise<boolean>;
  ...
  reloadGpuiProjectBoardDomainScope(boardProject: GxserverProjectDomainState, fallbackLinkStoreProjects: readonly GxserverProjectDomainState[]): Promise<{
    boardProject: GxserverProjectDomainState;
    linkStoreProjects: GxserverProjectDomainState[];
  }>;
  writeGpuiProjectBoardConversationLinks(boardProject: GxserverProjectDomainState, nextLinks: BeadConversationLink[]): Promise<void>;
  upsertGpuiProjectBoardConversationLink(boardProject: GxserverProjectDomainState, initialLinkStoreProjects: readonly GxserverProjectDomainState[], args: {
  ...
  startGpuiProjectBoardWorktreeWork(boardProject: GxserverProjectDomainState, agent: SidebarAgentButton, prompt: string): Promise<GpuiCreatedProjectAgentSessionRecord>;
  ...
  replaceGpuiProjectBoardConversationLinkSession(boardProject: GxserverProjectDomainState, linkStoreProjects: readonly GxserverProjectDomainState[], args: {
      beadId?: string;
      oldGhostexSessionId: string;
  ...
  mutateGpuiProjectBoardConversationLinkStores(boardProject: GxserverProjectDomainState, linkStoreProjects: readonly GxserverProjectDomainState[], mutate: (
      currentLinks: BeadConversationLink[],
      storeProject: GxserverProjectDomainState,
    ) => BeadConversationLink[]): Promise<void>;
}
...
export const gpuiSidebarRuntimeProjectBoardMethods = {
  ...
  postGpuiProjectBoardConversationResponse(this: GpuiSidebarRuntime, response: {
    error?: string;
    ok: boolean;
    payload?: unknown;
    requestId: string;
  ...
  async resolveGpuiProjectBoardDomainProject(this: GpuiSidebarRuntime, request: {
    projectId?: string;
    projectPath?: string;
  }): Promise<GxserverProjectDomainState> {
  ...
  async resolveGpuiProjectBoardDomainScope(this: GpuiSidebarRuntime, request: {
    projectId?: string;
    projectPath?: string;
  }): Promise<{
    boardProject: GxserverProjectDomainState;
  ...
  selectGpuiProjectBoardDomainProject(this: GpuiSidebarRuntime,
  ...
  async createGpuiProjectBoardConversationState(this: GpuiSidebarRuntime, request: {
    projectId?: string;
    projectPath?: string;
  }): Promise<ProjectBoardConversationState> {
  ...
  readGpuiProjectBoardConversationLinks(this: GpuiSidebarRuntime,
    linkStoreProjects: readonly GxserverProjectDomainState[],
  ): BeadConversationLink[] {
  ...
  createGpuiProjectBoardSessionOptions(this: GpuiSidebarRuntime,
    boardProject: GxserverProjectDomainState,
    linkStoreProjects: readonly GxserverProjectDomainState[] = [],
  ): ProjectBoardSessionOption[] {
  ...
  findGpuiProjectBoardLinkedSessionOption(this: GpuiSidebarRuntime,
    boardProject: GxserverProjectDomainState,
  ...
  async checkGpuiProjectBoardLinkAvailability(this: GpuiSidebarRuntime,
    boardProject: GxserverProjectDomainState,
    ghostexSessionId: string,
  ...
  async checkGpuiProjectBoardLinkResumable(this: GpuiSidebarRuntime, reference: {
    projectId: string;
    sessionId: string;
  }): Promise<boolean> {
  ...
  async findGpuiProjectBoardPreviousSessionRow(this: GpuiSidebarRuntime, reference: {
    projectId: string;
    sessionId: string;
  }): Promise<GxserverPresentationSearchResult | undefined> {
    if (!this.client) {
  ...
  async reloadGpuiProjectBoardDomainScope(this: GpuiSidebarRuntime,
    boardProject: GxserverProjectDomainState,
  ...
  async writeGpuiProjectBoardConversationLinks(this: GpuiSidebarRuntime,
    boardProject: GxserverProjectDomainState,
  ...
  async upsertGpuiProjectBoardConversationLink(this: GpuiSidebarRuntime,
    boardProject: GxserverProjectDomainState,
  ...
  async associateGpuiProjectBoardFocusedSession(this: GpuiSidebarRuntime, request: {
    beadDisplayId?: string;
    beadId?: string;
    projectId?: string;
    projectPath?: string;
  ...
  async startGpuiProjectBoardWork(this: GpuiSidebarRuntime, request: {
    agentId?: string;
    beadDisplayId?: string;
    beadId?: string;
    projectId?: string;
  ...
  async startGpuiProjectBoardWorktreeWork(this: GpuiSidebarRuntime,
    boardProject: GxserverProjectDomainState,
    agent: SidebarAgentButton,
    prompt: string,
  ...
  async jumpToGpuiProjectBoardConversation(this: GpuiSidebarRuntime, request: {
    beadId?: string;
    projectId?: string;
    projectPath?: string;
    sessionId?: string;
  ...
  async resumeGpuiProjectBoardConversation(this: GpuiSidebarRuntime, args: {
    beadId?: string;
    boardProject: GxserverProjectDomainState;
    linkStoreProjects: readonly GxserverProjectDomainState[];
    oldGhostexSessionId: string;
  ...
  async replaceGpuiProjectBoardConversationLinkSession(this: GpuiSidebarRuntime,
    boardProject: GxserverProjectDomainState,
    linkStoreProjects: readonly GxserverProjectDomainState[],
    args: {
      beadId?: string;
  ...
  async unlinkGpuiProjectBoardConversation(this: GpuiSidebarRuntime, request: {
    beadId?: string;
    projectId?: string;
    projectPath?: string;
    sessionId?: string;
  ...
  async mutateGpuiProjectBoardConversationLinkStores(this: GpuiSidebarRuntime,
    boardProject: GxserverProjectDomainState,
    linkStoreProjects: readonly GxserverProjectDomainState[],
    mutate: (
      currentLinks: BeadConversationLink[],
...
const gpuiSidebarRuntimeProjectBoardMethodsShapeCheck: GpuiSidebarRuntimeProjectBoardMethods = gpuiSidebarRuntimeProjectBoardMethods;
